...
<head>
	...
	<link rel="stylesheet" href="/skins/<?php echo Core::$skin; ?>/css/style.css" media="screen"  />
	<link rel="stylesheet" href="/skins/<?php echo Core::$skin; ?>/css/spec.css" media="screen" />
